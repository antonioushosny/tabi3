...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <?php endif; ?>
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-accounts-add"></i> <?php echo e(__('admin.areas')); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                <?php echo Form::open(['route'=>['areasdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'areass_form' ]); ?>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                    ...
                                    <a href="<?php echo e(route('addarea')); ?>" class=" add-modal btn btn-success btn-round" title="<?php echo e(trans('admin.add_area')); ?>">
                                        <?php echo e(trans('admin.add_area')); ?>
                            ...
                            <?php endif; ?>
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(trans('admin.city_id')); ?></th>
                                        <th><?php echo e(trans('admin.title_ar')); ?></th>
                                        <th><?php echo e(trans('admin.title_en')); ?></th>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="item<?php echo e($data->id); ?>">
                                        ...
                                        <?php if($data->city): ?>
                                            <?php if($lang == 'ar'): ?>
                                                <td><?php echo e($data->city->title_ar); ?></td>
                                            <?php else: ?> 
                                                <td><?php echo e($data->city->title_en); ?></td>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <td> </td>
                                        <?php endif; ?>
                                        ...
                                        <td style="text-align:center"><span  class="col-green"><?php echo e(trans('admin.active')); ?></span></td> 
                                        <?php elseif($data->status == 'not_active'): ?>
                                        <td style="text-align:center"><span  class="col-red"><?php echo e(trans('admin.not_active')); ?></span></td> 
                                        <?php endif; ?>

                                        <td>
 
                                            <a href="<?php echo e(route('editarea',$data->id)); ?>" class="btn btn-info waves-effect waves-float waves-green btn-round " title="<?php echo e(trans('admin.edit')); ?>"><i class="zmdi zmdi-edit"></i></a>
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(URL::route("areasdeleteall")); ?>',
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7\htdocs\tabi3\resources\views/areas/index.blade.php ENDPATH**/ ?>