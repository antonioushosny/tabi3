<?php $__env->startSection('main'); ?>
  <main class="main">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item  active"><?php echo e(__('lang.create')); ?></li>
    </ol>
    <div class="container-fluid">
      <div class="animated fadeIn">
        <div class="card">
          <div class="card-header">
            <strong><?php echo e(__('lang.create')); ?></strong>
          </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/admin/sections/countries/create.blade.php ENDPATH**/ ?>