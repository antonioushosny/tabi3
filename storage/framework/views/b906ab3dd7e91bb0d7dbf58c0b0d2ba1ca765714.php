        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <?php endif; ?>
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('cities')); ?>"><i class="zmdi zmdi-accounts-add"></i> <?php echo e(__('admin.cities')); ?></a></li>
                    <li class="breadcrumb-item "><a href="javascript:void(0);"><?php echo e(__('admin.edit_citie')); ?></a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="header">
                            <h2><strong><?php echo e(trans('admin.'.$title)); ?></strong> <?php echo e(trans('admin.edit_citie')); ?>  </h2>
                            
                        </div>
                        <div class="body row">
                            <div class="col-lg-6">
                                <?php echo Form::open(['route'=>['storecitie'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ]); ?> 

                                    <div class="form-group form-float">
                                        <input type="hidden" value="<?php echo e($citie->id); ?>" name="id" required>
                                    </div>
                                    <div class= "form-group form-float"> 
                                    ...
                                    <div class="form-group form-float">
                                        <input type="text" value="<?php echo e($citie->title_ar); ?>" class="form-control" placeholder="<?php echo e(__('admin.placeholder_title_ar')); ?>" name="title_ar" required>
                                        <label id="name-ar-error" class="error" for="title_ar" style="">  </label>
                                    </div>
                                    <div class="form-group form-float">
                                        <input type="text" value="<?php echo e($citie->title_en); ?>" class="form-control" placeholder="<?php echo e(__('admin.placeholder_title_en')); ?>" name="title_en" required>
...
<script>
    ...
    $("#form_validation").submit(function(e){
        ...
        //    openModal();
          $.ajax({
              type: 'POST',
              url: '<?php echo e(URL::route("storecitie")); ?>',
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/cities/edit.blade.php ENDPATH**/ ?>