...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <?php endif; ?>
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-accounts-add"></i> <?php echo e(__('admin.cities')); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                <?php echo Form::open(['route'=>['citiesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'citiess_form' ]); ?>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                    ...
                                    <a href="<?php echo e(route('addcitie')); ?>" class=" add-modal btn btn-success btn-round" title="<?php echo e(trans('admin.add_citie')); ?>">
                                        <?php echo e(trans('admin.add_citie')); ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class="item<?php echo e($data->id); ?>">
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('editcitie',$data->id)); ?>" class="btn btn-info waves-effect waves-float waves-green btn-round " title="<?php echo e(trans('admin.edit')); ?>"><i class="zmdi zmdi-edit"></i></a>
            ...
            if (isConfirm) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        window.location.replace("<?php echo e(route('cities')); ?>");
                    }
                });
            } else {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(URL::route("citiesdeleteall")); ?>',
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/cities/index.blade.php ENDPATH**/ ?>