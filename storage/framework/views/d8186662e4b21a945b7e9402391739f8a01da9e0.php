                ...
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo Form::open(['route'=>['storecategorie'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ]); ?> 
                            ...
                            <?php if(isset($data->id)): ?>
                                <button class="btn btn-raised btn-primary btn-round waves-effect add" type="submit"><?php echo e(__('admin.edit')); ?></button>
                            <?php else: ?>
                                <button class="btn btn-raised btn-primary btn-round waves-effect add" type="submit"><?php echo e(__('admin.add')); ?></button>
                            <?php endif; ?>
                        </form>
                    </div>
                </div>
          ...
          $.ajax({
              ...
              success: function(data) {
                  if ((data.errors)) {                        
                        ...
                        if (data.errors.days) {
                            $('#days-error').css('display', 'inline-block');
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/categories/add.blade.php ENDPATH**/ ?>