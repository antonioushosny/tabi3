        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <?php endif; ?>
                    ...
                    <li class="breadcrumb-item "><a href="javascript:void(0);"><?php echo e(__('admin.edit_area')); ?></a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="header">
                        <h2><strong><?php echo e(trans('admin.'.$title)); ?></strong> <?php echo e(trans('admin.edit_area')); ?>  </h2>
                    ...
                    <div class="body row">
                            ...
                            <?php echo Form::open(['route'=>['storearea'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ]); ?> 
                                ...
                                <div class="form-group form-float">
                                    <input type="hidden" value="<?php echo e($area->id); ?>" name="id" required>
                                </div>
                                <div class="form-group form-float">
                                    <input type="text" value="<?php echo e($area->title_ar); ?>" class="form-control" placeholder="<?php echo e(__('admin.placeholder_title_ar')); ?>" name="title_ar" required>
                                    <label id="name-ar-error" class="error" for="title_ar" style="">  </label>
                                </div>
                                <div class="form-group form-float">
                                    <input type="text" value="<?php echo e($area->title_en); ?>" class="form-control" placeholder="<?php echo e(__('admin.placeholder_title_en')); ?>" name="title_en" required>
                                    <label id="name-en-error" class="error" for="title_en" style="">  </label>
                                </div>
                                <div class= "form-group form-float"> 
                                    <?php echo Form::select('city_id',$cities
                                        ,$area->city_id,['class'=>'form-control show-tick' ,'placeholder' =>trans('admin.choose_city'),'required']); ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/areas/edit.blade.php ENDPATH**/ ?>