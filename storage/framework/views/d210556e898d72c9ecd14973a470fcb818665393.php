        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <?php endif; ?>
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('departments')); ?>"><i class="zmdi zmdi-accounts-add"></i> <?php echo e(__('admin.departments')); ?></a></li>
                    <li class="breadcrumb-item "><a href="javascript:void(0);"><?php echo e(__('admin.add_department')); ?></a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="header">
                        <h2><strong><?php echo e(trans('admin.'.$title)); ?></strong> <?php echo e(trans('admin.add_department')); ?>  </h2>
                        
                    </div>
                    <div class="body">
                        <?php echo Form::open(['route'=>['storedepartment'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ]); ?> 
                            <!-- for id -->
...
<script>
    ...
    $("#form_validation").submit(function(e){
        ...
        //    openModal();
          $.ajax({
              type: 'POST',
              url: '<?php echo e(URL::route("storedepartment")); ?>',
              ...
              success: function(data) {
                  if ((data.errors)) {                        
                        ...
                        window.location.replace("<?php echo e(route('departments')); ?>");
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7\htdocs\tabi3\resources\views/departments/add.blade.php ENDPATH**/ ?>