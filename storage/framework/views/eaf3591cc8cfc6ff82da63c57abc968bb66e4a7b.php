...
<section class="content home">
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                <?php echo Form::open(['route'=>['advertisingAdvertisementsdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'advertisementss_form' ]); ?>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                     ...
                                     <a href="<?php echo e(route('addadvertisingAdvertisement')); ?>" class=" add-modal btn btn-success btn-round" title="<?php echo e(trans('admin.add_advertisement')); ?>">
                                        <?php echo e(trans('admin.add_advertisement')); ?>
                            ...
                            <?php endif; ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class="item<?php echo e($data->id); ?>">
                                        ...
                                        <td>
                                             <a href="<?php echo e(route('editadvertisingAdvertisement',$data->id)); ?>" class="btn btn-info waves-effect waves-float waves-green btn-round " title="<?php echo e(trans('admin.edit')); ?>"><i class="zmdi zmdi-edit"></i></a> 

                                            <a href="<?php echo e(route('showadvertisingAdvertisement',$data->id)); ?>" class="btn btn-info waves-effect waves-float d-none waves-green btn-round " title="<?php echo e(trans('admin.show')); ?>"><i class="zmdi zmdi-eye"></i></a>
    ...
    $(document).on('click', '.delete-modal', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/advertisingAdvertisements/delete/" + id,
                    data: {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(URL::route("advertisingAdvertisementsdeleteall")); ?>',
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/advertisingAdvertisements/index.blade.php ENDPATH**/ ?>