...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <?php endif; ?>
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-accounts-add"></i> <?php echo e(__('admin.locations')); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                <?php echo Form::open(['route'=>['locationsdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'locationss_form' ]); ?>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                    ...
                                    <a href="<?php echo e(route('addlocation')); ?>" class=" add-modal btn btn-success btn-round" title="<?php echo e(trans('admin.add_location')); ?>">
                                        <?php echo e(trans('admin.add_location')); ?>
                            ...
                            <?php endif; ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class="item<?php echo e($data->id); ?>">
                                        ...
                                        <?php if($data->country): ?>
                                            <?php if($lang == 'ar'): ?>
                                                <td><?php echo e($data->country->title_ar); ?></td>
                                            <?php else: ?> 
                                                <td><?php echo e($data->country->title_en); ?></td>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <td> </td>
                                        <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('editlocation',$data->id)); ?>" class="btn btn-info waves-effect waves-float waves-green btn-round " title="<?php echo e(trans('admin.edit')); ?>"><i class="zmdi zmdi-edit"></i></a>
    ...
    $(document).on('click', '.delete-modal', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/locations/delete/" + id,
                    data: {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(URL::route("locationsdeleteall")); ?>',
                        data:  new FormData($("#locationss_form")[0]),
                        processData: false,
                        contentType: false,
                        success: function(data) {
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/locations/index.blade.php ENDPATH**/ ?>