        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <?php endif; ?>
                    ...
                    <li class="breadcrumb-item "><a href="javascript:void(0);"><?php echo e(__('admin.edit_user')); ?></a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="header">
                            <h2><strong><?php echo e(trans('admin.'.$title)); ?></strong> <?php echo e(trans('admin.edit_user')); ?>  </h2>
                            
                        </div>
                        <div class="body">
                            <?php echo Form::open(['route'=>['storeuser'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ]); ?> 
                                <div class="form-group form-float">
                                    <input type="hidden" value="<?php echo e(isset($user) ? $user->id : ''); ?>" name="id" required>
                                </div>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tabi3\resources\views/users/edit.blade.php ENDPATH**/ ?>