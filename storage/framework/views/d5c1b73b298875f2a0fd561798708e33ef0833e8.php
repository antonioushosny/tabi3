                ...
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo Form::open(['route'=>['storecategorie'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ]); ?> 
                            ...
                            <div class="form-group form-float">
                                <input type="text" value="<?php echo e(!isset($data->cost)?'':$data->cost); ?>" class="form-control" placeholder="<?php echo e(__('admin.placeholder_cost')); ?>" name="title_en" required>
                                <label id="cost-error" class="error" for="cost" style="">  </label>
                            </div>
                            <div class="form-group form-float">
                                <input type="text" value="<?php echo e(!isset($data->days)?'':$data->days); ?>" class="form-control" placeholder="<?php echo e(__('admin.placeholder_days')); ?>" name="days" required>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tabi3\resources\views/categories/add.blade.php ENDPATH**/ ?>