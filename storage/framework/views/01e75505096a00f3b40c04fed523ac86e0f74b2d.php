                ...
                <div class="card">
                        ...
                        <div class="body">
                            <?php echo Form::open(['route'=>['storesetting'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ]); ?> 
                                ...
                                <div class="row">
                                    <div class="col-md-2"><?php echo e(__('admin.title_ar')); ?></div>
                                    <div class="col-md-10">
                                        <!-- for title_ar -->
                                    ...
                                    <div class="col-md-2"><?php echo e(__('admin.title_en')); ?></div>
                                    <div class="col-md-10">
                                        <!-- for title_en -->
                                        <div class="form-group form-float">
                                    ...
                                    <div class="col-md-2"><?php echo e(__('admin.cost')); ?></div>
                                    <div class="col-md-10">
                                        <!-- for cost -->
                                        <div class="form-group form-float">
                                            <input type="number" value="<?php echo e(!isset($data->disc_ar)?null:$data->disc_ar); ?>"  class="form-control" step="0.1" placeholder="<?php echo e(__('admin.placeholder_cost')); ?>" name="desc_ar" required>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/settings/ad.blade.php ENDPATH**/ ?>