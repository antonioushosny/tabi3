            ...
            <form class="form-horizontal" action="<?php echo e(route('admins')); ?>" method="get">
              <div class="row">
                <div class="form-group col-12 col-md-1 text-center">
	                <a href="<?php echo e(route('addadmin')); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                </div>
	          	...
	          	<div class="row">
	          		...
	          		<div class="col-12 col-md-2 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">
	          					<form method="POST" action="<?php echo e(route('destroyadmin', $admin->id)); ?>">
	          						<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/admin/sections/admins/index.blade.php ENDPATH**/ ?>