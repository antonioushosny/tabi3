                            ...
                            <?php echo Form::open(['route'=>['send_messages'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ]); ?> 
                                ...
                                <div class="row  clients hidden">
                                    ...
                                    <div class= "form-group form-float col-md-11">
                                        <?php echo Form::select('ids[]',[],'',['class'=>'form-control show-tick' ,'id' => 'selectmulty','multiple'=>true]); ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/settings/messages.blade.php ENDPATH**/ ?>