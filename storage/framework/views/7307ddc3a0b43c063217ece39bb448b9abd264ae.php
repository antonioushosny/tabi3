<?php $__env->startSection('main'); ?>
  <main class="main">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item  active"><?php echo e(__('lang.cities')); ?></li>
    </ol>
    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        ...
        <div class="card">
          <div class="card-body">
            <form class="form-horizontal" action="<?php echo e(route('cities')); ?>" method="get">
              <div class="row">
                <div class="form-group col-12 col-md-1 text-center">
	                <a href="<?php echo e(route('addcitie')); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                </div>
                <div class="form-group col-12 col-md-1 text-center">
                </div>
        ...
        <div class="card d-none d-md-block">
          <div class="card-header">
          	<div class="row">
          		...
          		<div class="col-12 col-md-2 text-center"><strong><?php echo e(__('admin.country')); ?></strong></div>
		          	...
		          	<div class="row">
		          		<div class="col-xs-12 col-md-2 text-md-center">
							<div class="row mb-2 mb-md-0">
								...
								<div class="col-8 col-md-12"><?php echo e($city->id); ?></div>
							</div>
		          		</div>

						<div class="col-12 col-md-2 text-md-center">
		          			<div class="row mb-2 mb-md-0">
		          				<div class="col-4 d-block d-md-none"><strong><?php echo e(__('admin.country')); ?></strong></div>
		          				<div class="col-8 col-md-12"><?php echo e($lang == 'ar' ? $city->country->title_ar : $city->country->title_en); ?></div>
		          			</div>
		          		</div>
		          		...
		          		<div class="col-12 col-md-2 text-md-center">
		          			<div class="row mb-2 mb-md-0">
		          				...
		          				<div class="col-8 col-md-12"><?php echo e($city->title_ar); ?></div>
		          			</div>
		          		</div>
						...
						<div class="col-12 col-md-2 text-md-center">
		          			<div class="row mb-2 mb-md-0">
		          				...
		          				<div class="col-8 col-md-12"><?php echo e($city->title_en); ?></div>
		          			</div>
		          		</div>
		          		...
		          		<div class="col-12 col-md-2">
		          			<div class="row mb-2 mb-md-0">
		          				...
		          				<div class="col-8 col-md-12">
		          					<form method="POST" action="<?php echo e(route('destroycitie', $city->id)); ?>">
		          						<?php echo csrf_field(); ?>
		          						<?php echo method_field('GET'); ?>
 
										<a href="<?php echo e(route('editcitie', $city->id)); ?>" 
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/admin/sections/cities/index.blade.php ENDPATH**/ ?>