        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'countries') ? "class='active open'" : ""; ?> ><a href="<?php echo e(route('countries')); ?>"  ><i class="zmdi zmdi-flag"></i> <span> <?php echo e(trans('admin.countries')); ?></span></a></li>
                    ...
                    <li <?php echo ($page == 'locations') ? "class='active open'" : ""; ?> ><a href="<?php echo e(route('locations')); ?>"  ><i class="zmdi zmdi-pin-drop"></i> <span> <?php echo e(trans('admin.locations')); ?></span></a></li>
                    ...
                    <li <?php echo ($page == 'delegates') ? "class='active open'" : ""; ?> ><a href="<?php echo e(route('delegates')); ?>"  ><i class="zmdi zmdi-account"></i> <span> <?php echo e(trans('admin.delegates')); ?></span></a></li>
                    
                    <li <?php echo ($page == 'payments') ? "class='active open'" : ""; ?> ><a href="<?php echo e(route('payments')); ?>"  ><i class="zmdi zmdi-money-box"></i> <span> <?php echo e(trans('admin.payments')); ?></span></a></li>
                    ...
                    <li <?php echo ($page == 'advertisingAdvertisements') ? "class='active open'" : ""; ?> ><a href="<?php echo e(route('advertisingAdvertisements')); ?>"  ><i class="zmdi zmdi-aspect-ratio-alt"></i> <span> <?php echo e(trans('admin.advertisingAdvertisements')); ?></span></a></li>
                    ...
                    <li <?php echo ($page == 'AboutUs' || $page == 'Terms' || $page == 'Policy'|| $page == 'informations' || $page == 'messages') ? "class='active open'" : ""; ?> > <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-settings"></i><span><?php echo e(trans('admin.settings')); ?></span> </a>
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'install') ? "class='active open'" : ""; ?> ><a href="<?php echo e(route('editsetting','install')); ?>"  > <span> <?php echo e(trans('admin.install_ads')); ?></span></a></li>                            
                            
                            <li <?php echo ($page == 'star') ? "class='active open'" : ""; ?> ><a href="<?php echo e(route('editsetting','star')); ?>"  > <span> <?php echo e(trans('admin.star_ads')); ?></span></a></li>                            
                            <li <?php echo ($page == 'uploade_video') ? "class='active open'" : ""; ?> ><a href="<?php echo e(route('editsetting','uploade_video')); ?>"  > <span> <?php echo e(trans('admin.uploade_video')); ?></span></a></li>                            
...
</html><?php /**PATH D:\xampp7\htdocs\tabi3\resources\views/layouts/index.blade.php ENDPATH**/ ?>