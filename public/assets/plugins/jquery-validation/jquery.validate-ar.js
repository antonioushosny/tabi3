	...
	validate: function( options ) {
		...
		if ( !this.length ) {
			if ( options && options.debug && window.console ) {
				console.warn( "لم يتم تحديد أي شيء ، لا يمكن التحقق من صحة ، إرجاع شيء." );
			}
			return;
		}
...
$.extend( $.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format( "الرجاء عدم إدخال أكثر من {0} حروف." ),
		minlength: $.validator.format( "الرجاء إدخال على الأقل {0} حروف." ),
		rangelength: $.validator.format( "	الرجاء إدخال قيمة بين {0} و {1} حرف ." ),
		...
		step: $.validator.format( "	الرجاء إدخال مضاعفات {0}." )
	},
