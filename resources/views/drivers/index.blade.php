...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-accounts-add"></i> {{__('admin.drivers')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                {!! Form::open(['route'=>['driversdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'driverss_form' ])!!}
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                    ...
                                    <a href="{{route('adddriver')}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_driver')}}">
                                        {{trans('admin.add_driver')}}
                                    </a>
                                </li>
                                </li>
    ...
    $(document).on('click', '.delete-modal', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/drivers/delete/" + id,
                    data: {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ URL::route("driversdeleteall") }}',
                        data:  new FormData($("#driverss_form")[0]),
                        processData: false,
                        contentType: false,
                        success: function(data) {
