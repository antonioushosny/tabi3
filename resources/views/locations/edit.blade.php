        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item "><a href="javascript:void(0);">{{__('admin.edit_location')}}</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="header">
                            <h2><strong>{{trans('admin.'.$title)}}</strong> {{trans('admin.edit_location')}}  </h2>
                            ...
                            <div class="col-lg-6">
                                {!! Form::open(['route'=>['storelocation'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ])!!} 
                                    ...
                                    <div class="form-group form-float">
                                        <input type="hidden" value="{{$location->id}}" name="id" required>
                                    </div>
                                    <div class= "form-group form-float"> 
                                    ...
                                    <div class="form-group form-float">
                                        <input type="text" value="{{$location->title_ar}}" class="form-control" placeholder="{{__('admin.placeholder_title_ar')}}" name="title_ar" required>
                                        <label id="name-ar-error" class="error" for="title_ar" style="">  </label>
                                    </div>
                                    <div class="form-group form-float">
                                        <input type="text" value="{{$location->title_en}}" class="form-control" placeholder="{{__('admin.placeholder_title_en')}}" name="title_en" required>
