...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-accounts-add"></i> {{__('admin.locations')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                {!! Form::open(['route'=>['locationsdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'locationss_form' ])!!}
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                    ...
                                    <a href="{{route('addlocation')}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_location')}}">
                                        {{trans('admin.add_location')}}
                                    </a>
                                </li>
                                ...
                                <tbody>
                                    ...
                                    <tr class="item{{$data->id}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('editlocation',$data->id)}}" class="btn btn-info waves-effect waves-float waves-green btn-round " title="{{trans('admin.edit')}}"><i class="zmdi zmdi-edit"></i></a>
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ URL::route("locationsdeleteall") }}',
