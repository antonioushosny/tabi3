 ...
 @section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="{{ route('subcategories') }}">{{trans('admin.subcategories')}}</a></li>
        </ol>
    </section>
    ...
    <!-- Main content -->
     <?php $msg = trans('admin.confirm_delete') ; ?> 
      {!! Form::open(['route'=>['subcategoriesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'subcategoriess_form' ])!!}
                  ...
                  <div class="panel-heading">
                    <section class="content-header" style=" !important;">
                        <div class="row" style="display:flex;">
                            <div class="col-md-8" >
                                <span style="font-size:2em ;"><i class="fa fa-cog"></i> {{trans('admin.subcategories')}}</span>

                            </div>
                            <div class=" col-md-4">
                                <a href="#" class="add-modal btn btn-primary"><i class="fa fa-plus" ></i> {{trans('admin.add_subcategory')}}</a>  
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                         ...
                         {!! Form::open(['route'=>['storesubcategorie'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formaddsubcategories'])!!}
 
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.add_subcategorie')}}</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row"  style="display:flex;">
                                        ...
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('name_ar','',['class'=>'form-control','id' => 'name_ar_field','placeholder' => trans('admin.placeholder_name_ar')]) !!}
                                                    </span>
                                                    <span style="color: red " class="name_ar text-center hidden"></span>
                                                </div>
                                    ...
                                    <div class="row"  style="display:flex;">
                                        ...
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('name_en','',['class'=>'form-control','id' => 'name_en_field','placeholder' => trans('admin.placeholder_name_en')]) !!}
                                                    </span>
                                                    <span style="color: red " class="name_en text-center hidden"></span>
                                                </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        {{--  <h4 class="modal-title"></h4>  --}}
                         <div class="panel-heading " style="text-align: center"> <h4>{{trans('admin.delete_subcategorie')}}</h4>
                        </div>  
                    </div>
                    <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                            ...
                            {!! Form::open(['route'=>['editsubcategorie'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formeditsubcategories'])!!}
                            {!! Form::hidden('id','',['class'=>'form-control foridedit','id' => 'id_edit']) !!}
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.edit_subcategorie')}}</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row"  style="display:flex;">
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('name_ar','',['class'=>'form-control','id' => 'name_ar_edit','placeholder' => trans('admin.placeholder_name_ar')]) !!}
                                                    </span>
                                                    <span style="color: red " class="name_ar1 text-center hidden"></span>
                                                </div>
                                    ...
                                    <div class="row"  style="display:flex;">
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('name_en','',['class'=>'form-control','id' => 'name_en_edit','placeholder' => trans('admin.placeholder_name_en')]) !!}
                                                    </span>
                                                    <span style="color: red " class="name_en1 text-center hidden"></span>
                                                </div>
  ...
  <script>
      ...
      jQuery(function($){
        ...
        $(document).on('click', '.edit-modal', function() {
            ...
            $('.name_ar1').addClass('hidden');
            $('.name_en1').addClass('hidden');
        ...
        $(document).on('click', '.add-modal', function() {
            ...
            image = "{{asset('images/default.png')}}"  ;
            $('#formaddsubcategories')[0].reset();
            $('#changeimage').attr('src', image );
            $('.name_ar').addClass('hidden');
            $('.name_en').addClass('hidden');
        ...
        $('.modal-footer').on('click', '.delete', function() {
            ...
            if(choices.length >= 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ URL::route("subcategoriesdeleteall") }}',
        ...
        //this for deleteall 
        $('#subcategoriess_form').submit(function(e){
            e.preventDefault();
            var choices = [];
            checkboxes = document.getElementsByName('ids[]');
            for (var i=0;i<checkboxes.length;i++){
        ...
        $("#formaddsubcategories").submit(function(e){
           {{--  $('#addModal').modal('hide');  --}}
           $('.add').disabled =true;
          e.preventDefault();
          var form = $(this);
          ...
          $.ajax({
              type: 'POST',
              url: '{{ URL::route("storesubcategorie") }}',
              data:  new FormData($("#formaddsubcategories")[0]),
              processData: false,
                contentType: false,
              ...
              success: function(data) {
                  ...
                  if ((data.errors)) {
                        ...
                        if (data.errors.name_ar) {
                            $('.name_ar').removeClass('hidden');
                            $('.name_ar').text(data.errors.name_ar);
                        }
                        if (data.errors.name_en) {
                            $('.name_en').removeClass('hidden');
                            $('.name_en').text(data.errors.name_en);
                        }
        ...
        $('#formeditsubcategories').submit(function(e) {
          {{--  $('#editModal').modal('hide');  --}}
            ...
            $.ajax({
                type: 'POST',
                url:'{{ URL::route("editsubcategorie") }}',
                data: new FormData($("#formeditsubcategories")[0]),
                processData: false,
                contentType: false,
                success: function(data) {
                    ...
                    if ((data.errors)) {
                       ...
                       toastr.error('{{trans('admin.Validation_error')}}', '{{trans('admin.Error_Alert')}}', {timeOut: 5000});
                        ...
                        if (data.errors.name_en) {
                            $('.name_en1').removeClass('hidden');
                            $('.name_en1').text(data.errors.name_en);
                        }
                        if (data.errors.image) {
