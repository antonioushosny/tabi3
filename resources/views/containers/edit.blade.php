        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item "><a href="javascript:void(0);">{{__('admin.edit_container')}}</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="header">
                            <h2><strong>{{trans('admin.'.$title)}}</strong> {{trans('admin.edit_container')}}  </h2>
                        ...
                        <div class="body">
                            {!! Form::open(['route'=>['storecontainer'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ])!!} 
                                ...
                                <div class="form-group form-float">
                                    <input type="hidden" value="{{$container->id}}" name="id" required>
                                </div>
                                <!-- for name_ar -->
                                <div class="form-group form-float">
                                    <input type="text" value="{{$container->name_ar}}" class="form-control" placeholder="{{__('admin.placeholder_name_ar')}}" name="name_ar" required>
                                    <label id="name-ar-error" class="error" for="name_ar" style="">  </label>
                                </div>
                                <!-- for name_en -->
                                <div class="form-group form-float">
                                    <input type="text" value="{{$container->name_en}}" class="form-control" placeholder="{{__('admin.placeholder_name_en')}}" name="name_en" required>
                                ...
                                <!-- for desc_ar -->
                                <div class="form-group form-float">
                                    <textarea rows="4"  name="desc_ar"  class="form-control no-resize"  placeholder="{{__('admin.placeholder_desc_ar')}}" > {{$container->desc_ar}} </textarea>

                                    <label id="desc-ar-error" class="error" for="desc_ar" style="">  </label>
                                </div>
                                <!-- for desc_en -->
                                <div class="form-group form-float">
                                    <textarea rows="4" name="desc_en"  class="form-control no-resize"  placeholder="{{__('admin.placeholder_desc_en')}}" > {{$container->desc_en}} </textarea>
                                ...
                                <div class="form-group form-float row"  >
                                    ...
                                    <div class="col-md-10">
                                        @if($container->image)
                                            <img id="changeimage" src="{{asset('img/'.$container->image)}}" width="100px" height="100px" alt=" {{trans('admin.image')}}" />
                                        @else 
                                ...
                                <div class="form-group">
                                    <div class="radio inlineblock m-r-20">
                                        <input type="radio" name="status" id="active" class="with-gap" value="active" <?php echo ($container->status == 'active') ? "checked=''" : ""; ?> >
                                        <label for="active">{{__('admin.active')}}</label>
                                    </div>                                
                                    <div class="radio inlineblock">
                                        <input type="radio" name="status" id="not_active" class="with-gap" value="not_active" <?php echo ($container->status == 'not_active') ? "checked=''" : ""; ?> >
