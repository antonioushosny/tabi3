        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-accounts-add"></i> {{__('admin.packages')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                @if(Auth::user()->role == 'admin')
                                    ...
                                    <a href="{{route('addpackage')}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_package')}}">
                                        {{trans('admin.add_package')}}
                                    </a>
                                </li>
                                </li>
                            ...
                            @endif
                                ...
                                <tbody>
                                    ...
                                    <tr class="item{{$data->id}}">
                                        ...
                                        @if(Auth::user()->role == 'admin')
                                        <td>
                                            <a href="{{route('editpackage',$data->id)}}" class="btn btn-info waves-effect waves-float waves-green btn-round " title="{{trans('admin.edit')}}"><i class="zmdi zmdi-edit"></i></a>
