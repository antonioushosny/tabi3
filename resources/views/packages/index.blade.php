 ...
 @section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="{{ route('packages') }}">{{trans('admin.packages')}}</a></li>
        </ol>
    </section>
    ...
    <!-- Main content -->
     <?php $msg = trans('admin.confirm_delete') ; ?> 
      {!! Form::open(['route'=>['packagesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'packagess_form' ])!!}
                  ...
                  <div class="panel-heading">
                    <section class="content-header" style=" !important;">
                        <div class="row" style="display:flex;">
                            <div class="col-md-8" >
                                <span style="font-size:2em ;"><i class="fa fa-cog"></i> {{trans('admin.packages')}}</span>

                            </div>
                            <div class=" col-md-4">
                                <a href="#" class="add-modal btn btn-primary"><i class="fa fa-plus" ></i> {{trans('admin.add_package')}}</a>  
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                         ...
                         {!! Form::open(['route'=>['storepackage'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formaddpackages'])!!}
 
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.add_package')}}</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row"  style="display:flex;">
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('cost','',['class'=>'form-control','id' => 'cost_field','placeholder' => trans('admin.placeholder_cost')]) !!}
                                                    </span>
                                                    <span style="color: red " class="cost text-center hidden"></span>
                                                </div>
                                    ...
                                    <div class="row"  style="display:flex;">
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('points','',['class'=>'form-control','id' => 'points_field','placeholder' => trans('admin.placeholder_points')]) !!}
                                                    </span>
                                    ...
                                    <div class="row"  style="display:flex;">
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('coupons','',['class'=>'form-control','id' => 'coupons_field','placeholder' => trans('admin.placeholder_coupons')]) !!}
                                                    </span>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        {{--  <h4 class="modal-title"></h4>  --}}
                         <div class="panel-heading " style="text-align: center"> <h4>{{trans('admin.delete_package')}}</h4>
                        </div>  
                    </div>
                    <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                            ...
                            {!! Form::open(['route'=>['editpackage'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formeditpackages'])!!}
                            {!! Form::hidden('id','',['class'=>'form-control foridedit','id' => 'id_edit']) !!}
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.edit_package')}}</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row"  style="display:flex;">
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('cost','',['class'=>'form-control','id' => 'cost_edit','placeholder' => trans('admin.placeholder_cost')]) !!}
                                                    </span>
                                                    <span style="color: red " class="cost1 text-center hidden"></span>
                                                </div>
                                    ...
                                    <div class="row"  style="display:flex;">
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('points','',['class'=>'form-control','id' => 'points_edit','placeholder' => trans('admin.placeholder_points')]) !!}
                                                    </span>
                                    ...
                                    <div class="row"  style="display:flex;">
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('coupons','',['class'=>'form-control','id' => 'coupons_edit','placeholder' => trans('admin.placeholder_coupons')]) !!}
                                                    </span>
  ...
  <script>
      ...
      jQuery(function($){
        ...
        $(document).on('click', '.edit-modal', function() {
            ...
            $('.cost1').addClass('hidden');
            $('.points1').addClass('hidden');
            $('.coupons1').addClass('hidden');
        ...
        $('.modal-footer').on('click', '.delete', function() {
            ...
            if(choices.length >= 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ URL::route("packagesdeleteall") }}',
                    data:  new FormData($("#packagess_form")[0]),
                    processData: false,
                      contentType: false,
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/packages/delete/" + id,
                    data: {
        ...
        //this for deleteall 
        $('#packagess_form').submit(function(e){
            e.preventDefault();
            var choices = [];
            checkboxes = document.getElementsByName('ids[]');
            for (var i=0;i<checkboxes.length;i++){
        ...
        $("#formaddpackages").submit(function(e){
           {{--  $('#addModal').modal('hide');  --}}
           $('.add').disabled =true;
          e.preventDefault();
          var form = $(this);
          ...
          $.ajax({
              ...
              data:  new FormData($("#formaddpackages")[0]),
              processData: false,
                contentType: false,
        ...
        $('#formeditpackages').submit(function(e) {
          {{--  $('#editModal').modal('hide');  --}}
            ...
            $.ajax({
                type: 'POST',
                url:'{{ URL::route("editpackage") }}',
                data: new FormData($("#formeditpackages")[0]),
                processData: false,
                contentType: false,
                success: function(data) {
                    $('.title_ar1').addClass('hidden');
                    $('.title_en1').addClass('hidden');
                    $('.cos1t').addClass('hidden');
                    $('.points1').addClass('hidden');
                    $('.coupons1').addClass('hidden');
                    $('.status1').addClass('hidden');                  
                    ...
                    if ((data.errors)) {
                       ...
                       toastr.error('{{trans('admin.Validation_error')}}', '{{trans('admin.Error_Alert')}}', {timeOut: 5000});
                        ...
                        if (data.errors.cost) {
                            $('.cost1').removeClass('hidden');
                            $('.cost1').text(data.errors.cost);
                        }
                        if (data.errors.points) {
                        ...
                        if (data.errors.coupons) {
                            $('.coupons1').removeClass('hidden');
                            $('.coupons1').text(data.errors.coupons);
                        }
                        if (data.errors.status) {
