      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input class="form-control {{ $errors->first('title_ar') ? 'is-invalid' : '' }}" type="text"
                ...
                value="{{ old('title_ar', isset($countrie) ? $countrie->title_ar : '') }}">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input class="form-control {{ $errors->first('title_en') ? 'is-invalid' : '' }}" type="text"
                ...
                value="{{ old('title_en', isset($countrie) ? $countrie->title_en : '') }}">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              @include('admin.layouts.includes.imagePreview', ['name' => 'image', 'value' => isset($countrie) ? $countrie->image : null])
