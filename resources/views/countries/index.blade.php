 ...
 @section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="{{ route('countries') }}">{{trans('admin.countries')}}</a></li>
        </ol>
    </section>
    ...
    <!-- Main content -->
     <?php $msg = trans('admin.confirm_delete') ; ?> 
      {!! Form::open(['route'=>['countriesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'countriess_form' ])!!}
                  ...
                  <div class="panel-heading">
                    <section class="content-header" style=" !important;">
                        <div class="row" style="display:flex;">
                            <div class="col-md-8" >
                                <span style="font-size:2em ;"><i class="fa fa-cog"></i> {{trans('admin.countries')}}</span>

                            </div>
                            <div class=" col-md-4">
                                <a href="#" class="add-modal btn btn-primary"><i class="fa fa-plus" ></i> {{trans('admin.add_country')}}</a>  
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                         ...
                         {!! Form::open(['route'=>['storecountrie'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formaddcountries'])!!}
 
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.add_countrie')}}</h4>
                                </div>
                                <div class="panel-body">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        {{--  <h4 class="modal-title"></h4>  --}}
                         <div class="panel-heading " style="text-align: center"> <h4>{{trans('admin.delete_countrie')}}</h4>
                        </div>  
                    </div>
                    <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                            ...
                            {!! Form::open(['route'=>['editcountrie'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formeditcountries'])!!}
                            {!! Form::hidden('id','',['class'=>'form-control foridedit','id' => 'id_edit']) !!}
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.edit_countrie')}}</h4>
                                </div>
                                <div class="panel-body">
      ...
      jQuery(function($){
        ...
        $('.modal-footer').on('click', '.delete', function() {
            ...
            if(choices.length >= 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ URL::route("countriesdeleteall") }}',
                    data:  new FormData($("#countriess_form")[0]),
                    processData: false,
                      contentType: false,
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/countries/delete/" + id,
                    data: {
        ...
        //this for deleteall 
        $('#countriess_form').submit(function(e){
            e.preventDefault();
            var choices = [];
            checkboxes = document.getElementsByName('ids[]');
            for (var i=0;i<checkboxes.length;i++){
        ...
        $("#formaddcountries").submit(function(e){
           {{--  $('#addModal').modal('hide');  --}}
           $('.add').disabled =true;
          e.preventDefault();
          var form = $(this);
          ...
          $.ajax({
              ...
              data:  new FormData($("#formaddcountries")[0]),
              processData: false,
                contentType: false,
        ...
        $('#formeditcountries').submit(function(e) {
          {{--  $('#editModal').modal('hide');  --}}
            ...
            $.ajax({
                type: 'POST',
                url:'{{ URL::route("editcountrie") }}',
                data: new FormData($("#formeditcountries")[0]),
                processData: false,
                contentType: false,
                success: function(data) {
