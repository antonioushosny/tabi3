        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-accounts-add"></i> {{__('admin.countries')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                {!! Form::open(['route'=>['countriesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'countriess_form' ])!!}
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                    ...
                                    <a href="{{route('addcountrie')}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_countrie')}}">
                                        {{trans('admin.add_countrie')}}
                                    </a>
                                </li>
                            ...
                            @endif
                                ...
                                <tbody>
                                    ...
                                    <tr class="item{{$data->id}}">
                                        ...
                                        <td>
                                            <a href="{{route('editcountrie',$data->id)}}" class="btn btn-info waves-effect waves-float waves-green btn-round " title="{{trans('admin.edit')}}"><i class="zmdi zmdi-edit"></i></a>
