 ...
 @section('content')
    ...
    <!-- Main content -->
     <?php $msg = trans('admin.confirm_delete') ; ?> 
      {!! Form::open(['route'=>['staticsdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'staticss_form' ])!!}
                  ...
                  <div class="panel-heading">
                    <section class="content-header" style=" !important;">
                        <div class="row" style="display:flex;">
                            <div class="col-md-8" >
                                <span style="font-size:2em ;"><i class="fa fa-cog"></i> {{trans('admin.statics')}}</span>

                            </div>
                            <div class=" col-md-4">
                                <a href="#" class="add-modal btn btn-primary"><i class="fa fa-plus" ></i> {{trans('admin.add_static')}}</a>  
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                         ...
                         {!! Form::open(['route'=>['storestatic'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formaddstatics'])!!}
                            {!! Form::hidden('type',$type,['class'=>'form-control']) !!}
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.add_static')}}</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row"  style="display:flex;">
                                        ...
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::textarea('disc_ar','',['class'=>'form-control','rows'=>'4','id' => 'disc_ar_field','placeholder' => trans('admin.placeholder_disc_artitle_ar')]) !!}
                                                    </span>
                                    ...
                                    <div class="row"  style="display:flex;">
                                        ...
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::textarea('disc_en','',['class'=>'form-control','rows'=>'4','id' => 'disc_en_field','placeholder' => trans('admin.placeholder_disc_en')]) !!}
                                                    </span>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        {{--  <h4 class="modal-title"></h4>  --}}
                         <div class="panel-heading " style="text-align: center"> <h4>{{trans('admin.delete_static')}}</h4>
                        </div>  
                    </div>
                    <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                            ...
                            {!! Form::open(['route'=>['editstatic'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formeditstatics'])!!}
                            {!! Form::hidden('id','',['class'=>'form-control foridedit','id' => 'id_edit']) !!}
                            {!! Form::hidden('type',$type,['class'=>'form-control']) !!}
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.edit_static')}}</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row"  style="display:flex;">
                                        ...
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::textarea('disc_ar','',['class'=>'form-control','rows'=>'4','id' => 'disc_ar_edit','placeholder' => trans('admin.placeholder_disc_artitle_ar')]) !!}
                                                    </span>
                                    ...
                                    <div class="row"  style="display:flex;">
                                        ...
                                        <div class= "col-md-12 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::textarea('disc_en','',['class'=>'form-control','rows'=>'4','id' => 'disc_en_edit','placeholder' => trans('admin.placeholder_disc_en')]) !!}
                                                    </span>
      ...
      jQuery(function($){
        ...
        $('.modal-footer').on('click', '.delete', function() {
            ...
            if(choices.length >= 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ URL::route("staticsdeleteall") }}',
                    data:  new FormData($("#staticss_form")[0]),
                    processData: false,
                      contentType: false,
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/statics/delete/" + id,
                    data: {
        ...
        //this for deleteall 
        $('#staticss_form').submit(function(e){
            e.preventDefault();
            var choices = [];
            checkboxes = document.getElementsByName('ids[]');
            for (var i=0;i<checkboxes.length;i++){
        ...
        $("#formaddstatics").submit(function(e){
           {{--  $('#addModal').modal('hide');  --}}
           $('.add').disabled =true;
          e.preventDefault();
          var form = $(this);
          ...
          $.ajax({
              type: 'POST',
              url: '{{ URL::route("storestatic") }}',
              data:  new FormData($("#formaddstatics")[0]),
              processData: false,
                contentType: false,
        ...
        $('#formeditstatics').submit(function(e) {
          {{--  $('#editModal').modal('hide');  --}}
            ...
            $.ajax({
                type: 'POST',
                url:'{{ URL::route("editstatic") }}',
                data: new FormData($("#formeditstatics")[0]),
                processData: false,
                contentType: false,
                success: function(data) {
                    $('.title_ar1').addClass('hidden');
