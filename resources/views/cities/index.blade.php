 ...
 @section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="{{ route('cities') }}">{{trans('admin.cities')}}</a></li>
        </ol>
    </section>
                  ...
                  <div class="panel-heading">
                    <section class="content-header" style=" !important;">
                        <div class="row" style="display:flex;">
                            <div class="col-md-8" >
                                <span style="font-size:2em ;"><i class="fa fa-cog"></i> {{trans('admin.cities')}}</span>

                            </div>
                            <div class=" col-md-4">
                                <a href="#" class="add-modal btn btn-primary"><i class="fa fa-plus" ></i> {{trans('admin.add_city')}}</a>  
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                         ...
                         {!! Form::open(['route'=>['storecitie'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formaddcities'])!!}
 
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.add_citie')}}</h4>
                                </div>
                                <div class="panel-body">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        {{--  <h4 class="modal-title"></h4>  --}}
                         <div class="panel-heading " style="text-align: center"> <h4>{{trans('admin.delete_citie')}}</h4>
                        </div>  
                    </div>
                    <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                            ...
                            {!! Form::open(['route'=>['editcitie'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formeditcities'])!!}
                            {!! Form::hidden('id','',['class'=>'form-control foridedit','id' => 'id_edit']) !!}
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.edit_citie')}}</h4>
                                </div>
                                <div class="panel-body">
...
@section('script1')
  ...
  <script>
      ...
      jQuery(function($){
        ...
        //this for deleteall 
        $('#citiess_form').submit(function(e){
            e.preventDefault();
            var choices = [];
            checkboxes = document.getElementsByName('ids[]');
            for (var i=0;i<checkboxes.length;i++){
        ...
        $("#formaddcities").submit(function(e){
           {{--  $('#addModal').modal('hide');  --}}
           $('.add').disabled =true;
          e.preventDefault();
          var form = $(this);
          ...
          $.ajax({
              ...
              data:  new FormData($("#formaddcities")[0]),
              processData: false,
                contentType: false,
        ...
        $('#formeditcities').submit(function(e) {
          {{--  $('#editModal').modal('hide');  --}}
            ...
            $.ajax({
                type: 'POST',
                url:'{{ URL::route("editcitie") }}',
                data: new FormData($("#formeditcities")[0]),
                processData: false,
                contentType: false,
                success: function(data) {
