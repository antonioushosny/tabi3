 ...
 @section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="{{ route('categories') }}">{{trans('admin.categories')}}</a></li>
        </ol>
    </section>
    ...
    <!-- Main content -->
     <?php $msg = trans('admin.confirm_delete') ; ?> 
      {!! Form::open(['route'=>['categoriesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'categoriess_form' ])!!}
                  ...
                  <div class="panel-heading">
                    <section class="content-header" style=" !important;">
                        <div class="row" style="display:flex;">
                            <div class="col-md-8" >
                                <span style="font-size:2em ;"><i class="fa fa-cog"></i> {{trans('admin.categories')}}</span>

                            </div>
                            <div class=" col-md-4">
                                <a href="#" class="add-modal btn btn-primary"><i class="fa fa-plus" ></i> {{trans('admin.add_category')}}</a>  
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                         ...
                         {!! Form::open(['route'=>['storecategorie'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formaddcategories'])!!}
 
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.add_categorie')}}</h4>
                                </div>
                                <div class="panel-body">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        {{--  <h4 class="modal-title"></h4>  --}}
                         <div class="panel-heading " style="text-align: center"> <h4>{{trans('admin.delete_categorie')}}</h4>
                        </div>  
                    </div>
                    <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                            ...
                            {!! Form::open(['route'=>['editcategorie'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formeditcategories'])!!}
                            {!! Form::hidden('id','',['class'=>'form-control foridedit','id' => 'id_edit']) !!}
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.edit_categorie')}}</h4>
                                </div>
                                <div class="panel-body">
      ...
      jQuery(function($){
        ...
        $('.modal-footer').on('click', '.delete', function() {
            ...
            if(choices.length >= 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ URL::route("categoriesdeleteall") }}',
                    data:  new FormData($("#categoriess_form")[0]),
                    processData: false,
                      contentType: false,
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/categories/delete/" + id,
                    data: {
        ...
        //this for deleteall 
        $('#categoriess_form').submit(function(e){
            e.preventDefault();
            var choices = [];
            checkboxes = document.getElementsByName('ids[]');
            for (var i=0;i<checkboxes.length;i++){
        ...
        $("#formaddcategories").submit(function(e){
          ...
          $.ajax({
              ...
              data:  new FormData($("#formaddcategories")[0]),
              processData: false,
                contentType: false,
        ...
        $('#formeditcategories').submit(function(e) {
          {{--  $('#editModal').modal('hide');  --}}
            ...
            $.ajax({
                type: 'POST',
                url:'{{ URL::route("editcategorie") }}',
                data: new FormData($("#formeditcategories")[0]),
                processData: false,
                contentType: false,
                success: function(data) {
                    $('.name_ar1').addClass('hidden');
                    ...
                    if ((data.errors)) {
                       ...
                       toastr.error('{{trans('admin.Validation_error')}}', '{{trans('admin.Error_Alert')}}', {timeOut: 5000});
                        ...
                        if (data.errors.name_ar) {
                            $('.name_ar1').removeClass('hidden');
                            $('.name_ar1').text(data.errors.name_ar);
                        }
                        if (data.errors.name_en) {
