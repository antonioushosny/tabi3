                ...
                <div class="card">
                    ...
                    <div class="body">
                        {!! Form::open(['route'=>['storecategorie'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ])!!} 
                            ...
                            <div class="form-group form-float">
                                <input type="text" value="{{ !isset($data->cost)?'':$data->cost }}" class="form-control" placeholder="{{__('admin.placeholder_cost')}}" name="title_en" required>
                                <label id="cost-error" class="error" for="cost" style="">  </label>
                            </div>
                            <div class="form-group form-float">
                                <input type="text" value="{{ !isset($data->days)?'':$data->days }}" class="form-control" placeholder="{{__('admin.placeholder_days')}}" name="days" required>
