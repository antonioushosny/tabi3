...
<section class="content home">
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                {!! Form::open(['route'=>['advertisingAdvertisementsdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'advertisementss_form' ])!!}
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                     ...
                                     <a href="{{route('addadvertisingAdvertisement')}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_advertisement')}}">
                            ...
                            @endif
                                ...
                                <tbody>
                                    ...
                                    <tr class="item{{$data->id}}">
                                        ...
                                        <td>
                                             <a href="{{route('editadvertisingAdvertisement',$data->id)}}" class="btn btn-info waves-effect waves-float waves-green btn-round " title="{{trans('admin.edit')}}"><i class="zmdi zmdi-edit"></i></a> 

                                            <a href="{{route('showadvertisingAdvertisement',$data->id)}}" class="btn btn-info waves-effect waves-float d-none waves-green btn-round " title="{{trans('admin.show')}}"><i class="zmdi zmdi-eye"></i></a>
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ URL::route("advertisingAdvertisementsdeleteall") }}',
