        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="{{route('payments')}}"><i class="zmdi zmdi-accounts-add"></i> {{__('admin.payments')}}</a></li>
                    <li class="breadcrumb-item "><a href="javascript:void(0);">{{__('admin.add_payment')}}</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="header">
                        <h2><strong>{{trans('admin.'.$title)}}</strong> {{trans('admin.add_payment')}}  </h2>
                        
                    </div>
                    <div class="body">
                        {!! Form::open(['route'=>['storepayment'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ])!!} 
                            <!-- for id -->
          ...
          $.ajax({
              ...
              success: function(data) {
                  if ((data.errors)) {                        
                        ...
                        window.location.replace("{{route('payments')}}");
