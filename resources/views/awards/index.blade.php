 ...
 @section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="{{ route('awards') }}">{{trans('admin.awards')}}</a></li>
        </ol>
    </section>
                  ...
                  <div class="panel-heading">
                    <section class="content-header" style=" !important;">
                        <div class="row" style="display:flex;">
                            <div class="col-md-8" >
                                <span style="font-size:2em ;"><i class="fa fa-cog"></i> {{trans('admin.awards')}}</span>

                            </div>
                            <div class=" col-md-4">
                                <a href="#" class="add-modal btn btn-primary"><i class="fa fa-plus" ></i> {{trans('admin.add_award')}}</a>  
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                         ...
                         {!! Form::open(['route'=>['storeaward'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formaddawards'])!!}
 
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.add_award')}}</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row"  style="display:flex;">
                                        ...
                                        <div class= "col-md-6 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('coupons','',['class'=>'form-control','onkeypress'=>'isNumber(event); ','id' => 'coupons_field','placeholder' => trans('admin.placeholder_coupons')]) !!}
                                                    </span>
                                            ...
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        ...
                                                        {{--  {!! Form::text('expiry_date','',['class'=>'form-control','id' => 'expiry_date_field','placeholder' => trans('admin.placeholder_expiry_date')]) !!}  --}}
                                                    </span>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        {{--  <h4 class="modal-title"></h4>  --}}
                         <div class="panel-heading " style="text-align: center"> <h4>{{trans('admin.delete_award')}}</h4>
                        </div>  
                    </div>
                    <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-group">
                            ...
                            {!! Form::open(['route'=>['editaward'],'method'=>'post','autocomplete'=>'off','role'=>'form','id'=>'formeditawards'])!!}
                            {!! Form::hidden('id','',['class'=>'form-control foridedit','id' => 'id_edit']) !!}
                            <div class="panel panel-green">
                                <div class="panel-heading " style="text-align: center"> 
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h4>{{trans('admin.edit_award')}}</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row"  style="display:flex;">
                                        ...
                                        <div class= "col-md-6 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        {!! Form::text('coupons','',['class'=>'form-control','onkeypress'=>'isNumber(event); ','id' => 'coupons_edit','placeholder' => trans('admin.placeholder_coupons')]) !!}
                                                    </span>
                                        ...
                                        <div class= "col-md-6 col-xs-12">
                                            <div class="form-group  row" style="display:flex;">
                                                ...
                                                <div class="col-xs-9">
                                                    <span style="color: black "> 
                                                        <input type="datetime-local" name="expiry_date" class="form-control" id="expiry_date_edit" placeholder="{{trans('admin.placeholder_expiry_date')}}">
      ...
      jQuery(function($){
        ...
        $('.modal-footer').on('click', '.delete', function() {
            ...
            if(choices.length >= 1){
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/awards/delete/" + id,
                    data: {
        ...
        //this for deleteall 
        $('#awardss_form').submit(function(e){
            e.preventDefault();
            var choices = [];
            checkboxes = document.getElementsByName('ids[]');
            for (var i=0;i<checkboxes.length;i++){
        ...
        $("#formaddawards").submit(function(e){
           {{--  $('#addModal').modal('hide');  --}}
           $('.add').disabled =true;
          e.preventDefault();
          var form = $(this);
          ...
          $.ajax({
              type: 'POST',
              url: '{{ URL::route("storeaward") }}',
              data:  new FormData($("#formaddawards")[0]),
              processData: false,
                contentType: false,
        ...
        $('#formeditawards').submit(function(e) {
          {{--  $('#editModal').modal('hide');  --}}
            ...
            $.ajax({
                type: 'POST',
                url:'{{ URL::route("editaward") }}',
                data: new FormData($("#formeditawards")[0]),
                processData: false,
                contentType: false,
                success: function(data) {
                    $('.title_ar1').addClass('hidden');
